# Malta (MT) — Sustainability & Compliance Requirements (Draft)
...
> from the legislation.mt **metadata** (title + repeal notices, which DO render),
> the Chambers "Renewable Energy 2025 — Malta" practice guide, REWS pages, and the
> EC April-2026 infringements package (fetched via mandates cross-ref). Procedural
> details are PRIMARY-ONLY / gaps — logged honestly. EU voluntary-schemes list from
> DG ENER (fetched 2026-07-04).
...
- Malta follows the standard RED II model: economic operators demonstrate sustainability via **EU-recognised voluntary schemes** (or equivalent), producing a **Proof of Sustainability** per consignment. [PRIMARY-ONLY — S3, S7]
...
- Given Malta imports essentially all its biofuel, sustainability compliance rests on **imported PoS/voluntary-scheme documentation** passed to the obligated importer/wholesaler. [PRIMARY-ONLY — S3]

### 3.4 National registry / verifying authority

| Item | Detail | Confidence | Sources |
|---|---|---|---|
| Competent authority (licensing/compliance) | **Regulator for Energy and Water Services (REWS)** — issues authorisations for biofuel trade/supply (under S.L. 545.15) and supervises the substitution-obligation compliance | PRIMARY-ONLY | S3, S4 |
| Policy authority | **Energy and Water Agency (EWA)** — policy development, NECP coordination | PRIMARY-ONLY | S4 (mandates MT) |
| National registry | **No dedicated national biofuel-sustainability registry** identified; compliance runs via REWS authorisations + operator reporting and PoS documentation | UNCORROBORATED (gap) | S3, S4 |
| Who must register/report | Petroleum providers authorised as **importers and/or wholesalers** of petrol/diesel; they hold the REWS authorisation and pass on sustainability evidence | PRIMARY-ONLY | S3 |

### 3.5 Union Database (UDB) status

- EU UDB established under **RED III Art. 31a** (formal deadline 21 Nov 2024; operational from Jan 2024); chain-of-custody rules in **Impl. Reg. (EU) 2022/996 Art. 18**; collectors/EOs onboarded via **voluntary schemes** through 2024–2025; **mandatory-use/sanction date being finalised** by the Commission. [CONFIRMED (EU-level) — S1, S8, S9]
- **MT operators are in scope via EU law.** With RED III not transposed (and MT at the CJEU-referral stage), **no MT-specific UDB implementing provision** exists; the obligation applies directly. Operators risk **certificate suspension without a UDB account** (scheme-administered onboarding). [PRIMARY-ONLY / flag — S8, S9]
...
|---|---|---|---|
| Operator reporting to REWS / the Authority | Annual reporting on the substitution obligation and sustainability compliance to REWS; **exact deadline not located** (legislation.mt JS-only) | GAP | S3 |
| Sustainability documentation | PoS / voluntary-scheme evidence retained and provided on demand; voluntary-scheme audit cycle applies | PRIMARY-ONLY | S3, S7 |
| Penalties | Non-compliance penalties under S.L. 545.15 / the substitution obligation; **exact figures not located** | GAP | — |

## 4. Draft compliance-checklist items (this scope)

1. **Obtain the REWS authorisation** to trade/supply biofuel (S.L. 545.15) and maintain it. → REWS.
2. **Hold EU-recognised voluntary-scheme certification** (ISCC EU, REDcert, 2BSvs…) and obtain a valid **Proof of Sustainability** for every imported consignment. → certification body / supplier.
3. **Meet the GHG-saving thresholds** (biofuel 50/60/65 %; RFNBO 70 %) and document per batch. → self + verifier.
4. **File the annual substitution-obligation / sustainability report to REWS** (deadline to confirm) and retain PoS documentation. → REWS.
5. **Note Malta's exemption from the 1.7 % Annex IX-B cap**, apply double counting for wastes/residues, respect the 7 % crop cap and the EU high-ILUC (palm) phase-out. → self + verifier.
...
| S2 | https://legislation.mt/eli/sl/545.37/eng | 1 | 2026-07-04 | S.L. 545.37 Sustainability Criteria Regs — title + **repeal by LN 95 of 2026** (metadata) |
| S3 | https://practiceguides.chambers.com/practice-guides/renewable-energy-2025/malta | 2 | 2026-07-04 | S.L. 545.15 & 545.37 as sustainability instruments; REWS authorisation; RED II alignment |
| S4 | (repo) research/reports/drafts/MT-mandates-2026-07-04.md | — | 2026-07-04 | REWS/EWA roles; substitution obligation; double counting; 3.5% advanced 2030; IX-B derogation; RED III referral |
| S5 | https://legislation.mt/eli/sl/545.35/eng | 1 | 2026-07-04 | S.L. 545.35 repealed by LN 93 of 2026 (metadata) |
| S6 | https://ec.europa.eu/commission/presscorner/detail/en/ip_26_839 | 1 | 2026-07-04 | Referral of Malta (with EL, PT) to CJEU 29 Apr 2026, financial sanctions |
| S7 | https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:02022R0996-20231230 | 1 | 2026-07-04 | Impl. Reg. (EU) 2022/996 — verification/PoS/UDB rules operators must follow |
