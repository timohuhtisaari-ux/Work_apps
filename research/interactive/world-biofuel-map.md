...
**Coverage — 53 markets researched:** the **EU-27** (full RED III compliance reports), **Norway, UK, Switzerland**, **USA & Canada** (with state/province drill-down), and — added 2026-07-15 by the global research team — **South America** (Brazil, Argentina, Paraguay, Chile, Peru, Colombia) and **Asia** (Indonesia, Malaysia, Philippines, Thailand, Vietnam, Singapore, South Korea). Every other country renders in muted grey as *not yet researched* — no unverified guesses. The team extends coverage weekly and monitors mapped markets for changes.
...
|---|---|---|---|---|---|
| Austria | `AT` | Hybrid (dual) | Dual: GHG −8% (draft) + energy substitution 5.75% (petrol 3.4% / diesel 6.3%) | GHG −13% by 2030 | No |
| Belgium | `BE` | Energy-share | Energy-share obligation 12.2% (energy value) | 13.9% by 2030 | No |
| Bulgaria | `BG` | Volume-blending | Volume blending — petrol 9% bioethanol / diesel 6% biodiesel (incl. 1% advanced) | 14% RES-T (RED II floor) | No |
| Croatia | `HR` | Energy-share | Energy-share placing obligation 8.8–10.3% (unresolved) | NECP transport RES ~24.6% | No |
| Cyprus | `CY` | Volume-blending | Blending obligation 7.3% energy content (single source) | 14% RES-T | No |
| Czechia | `CZ` | GHG-reduction | GHG-reduction obligation ≈6.25% (Air Protection Act) | GHG −11% by 2030 | Yes |
| Denmark | `DK` | GHG-reduction | CO₂e displacement requirement ≥5.2% (2025–2027) | ≥7% by 2030 | Yes |
| Estonia | `EE` | Energy-share | Energy-share ≥7.5% (half-year weighted average) | Gap — 2027–2030 step-ups not located | No |
| Finland | `FI` | Energy-share | Distribution obligation 19.5% (energy) — 2nd-highest in the EU | 34% (energy) by 2030 | Yes |
| France | `FR` | Tax-incentive | TIRUERT incentive tax — petrol pool 10.5% / diesel pool 9.4% renewable energy (tax=0 if met, else 140 €/hL) | IRICC replaces TIRUERT from 2027 (numeric path in décrets — PROPOSED) | Yes |
| Germany | `DE` | GHG-reduction | GHG-reduction quota (THG-Quote) 12% | 26.5% GHG by 2030 — among the steepest EU trajectories | No |
| Greece | `EL` | Volume-blending | Volume blending — petrol 3.3% v/v bioethanol / diesel B7 (up to 7% FAME); static | Static — RED III 29%/14.5% not enacted | No |
| Hungary | `HU` | Energy-share | Energy-share 9.1% (petrol 6.1% bioethanol; diesel 9.6%, HVO ≥0.4%) | RES-T 25% (PRIMARY-ONLY) | No |
| Ireland | `IE` | Energy-share | RTFO 32% by energy content — the EU's highest 2026 headline | Rolls forward via annual S.I. (not isolated) | Yes |
| Italy | `IT` | Energy-share | CIC certificates — 12.60% (7.10 traditional + 5.50 advanced) | 16.00% by 2030 | Yes |
| Latvia | `LV` | Hybrid (dual) | Combined: GHG target + adv./RFNBO ≥1% + petrol-95 ≥9.5 vol%, diesel ≥6.5 vol% | GHG −16%; adv.+RFNBO ≥5.5% (≥1 pp RFNBO) | Yes |
| Lithuania | `LT` | Energy-share | Energy-share ≥9.8 percentage points (multiple counting; DAEI accounting units) | ≥16.8% by 2030 | No |
| Luxembourg | `LU` | Volume-blending | Energy-content coverage rate — 2025 = 8.8% (2026 value not obtained) | ~10% (policy target) | Yes |
| Malta | `MT` | Volume-blending | Substitution obligation — 2026 % NOT established (GAP) | 14% RES-T; ≥3.5% advanced | No |
| Netherlands | `NL` | GHG-reduction | GHG-based ERE units per sector — land 14.4% (binnenvaart 2.5%, zeevaart 2.9%) | Land 28.4% (binnenvaart 14.5%, zeevaart 8.2%) by 2030 | No |
| Poland | `PL` | Energy-share | National Indicative Target (NCW) 10% (≈8.5% effective after 0.85 coefficient) | 14.9% (statutory) by 2030 | No |
| Portugal | `PT` | Energy-share | Incorporation obligation 13% (TdB/TdC certificates) | 16% by 2030 | Yes |
| Romania | `RO` | Volume-blending | Volume blending — petrol ≥8% (temp min 2% under OUG 19/2026) / diesel ≥6.5% | RED III 14.5% GHG / 29% RES-T not legislated | No |
| Slovakia | `SK` | Volume-blending | Reference value 9.5% (energy content) | 11.4% by 2030 | No |
| Slovenia | `SI` | Energy-share | Energy-share 13.8% | 20.8% by 2030 | No |
| Spain | `ES` | Energy-share | SICBIOS certificates — 14% (raised from 12% by RD 5/2026) | 14% rolls forward (GHG-model draft PROPOSED) | No |
| Sweden | `SE` | GHG-reduction | Reduktionsplikt: petrol 10% / diesel 10% GHG-intensity cut | 10% (step-ups repealed — held flat to 2030) | Yes |
...
| Australia | `AU` | Volume-blending | NSW 6% ethanol + 2% biodiesel; QLD 4% ethanol + 0.5% biodiesel; no federal mandate; LCFS production support mid-2026 | QLD Amendment Bill 2026 proposes E9 (9%) & E2 (2%) if passed; federal demand measure under consultation, no 2030 level set | No |
| Bolivia | `BO` | Volume-blending | E12 (ethanol, since March 2024) | E21 (2026), E25 (2027–2028) per Law 1098 | No |
...
| China | `CN` | No mandate / voluntary | E10 regional only (15 prov, no expansion since 2019); SAF 1% pilot March 2025 (4 airports) | SAF 15% by 2030 (announced, not legislated) | No |
...
| Ecuador | `EC` | Volume-blending | E10 (nominal, Ecopaís); E2–4 (actual operative) | E10 long-term aspiration; no legislated 2030 target | No |
| India | `IN` | Volume-blending | E20 20%, B5 5% (2030), SAF 1% (2027) | E25 tbd, B5 5% 2030, SAF 5% 2030 | No |
...
| Japan | `JP` | Volume-blending | 824 M L bioethanol (ETBE) annually; 10% SAF aspirational; E10 pilot FY 2028, nationwide FY 2030 proposed | E10 nationwide 2030; SAF 10% 2030 | No |
...
| Mexico | `MX` | No mandate / voluntary | E5.8 (max, not required); E0 in 3 metros | SENER aspiration 10–20% E; 45% renewables by 2030 (non-fuel-specific) | No |
...
| Uruguay | `UY` | Volume-blending | E8.5 (ethanol); B0 (biodiesel repealed 2021) | No legislated increase; E8.5 to remain; B5 reinstatement proposed (not legislated) | No |
...
- **United Kingdom (GB):** RTFO GHG-saving threshold unresolved (50/60% vs 55–65%)
- **Estonia (EE):** 2027–2030 trajectory not located (GAP)
- **Poland (PL):** RED III NOT transposed — RED II only; draft UC106
- **Luxembourg (LU):** 2026 coverage rate, advanced sub-quota & penalty are a GAP
- **Czechia (CZ):** 2026 GHG figure rests on a single Tier-2 source
- **Switzerland (CH):** Obligation-trigger threshold & shortfall penalty are a GAP
- **Austria (AT):** KVO values UNCORROBORATED (RIS down); 2026 GHG 8% vs 7.5% CONFLICT
- **Hungary (HU):** Annex IX-B 4% cap & penalty rate UNCORROBORATED
- **Romania (RO):** Advanced sub-target UNCORROBORATED; OUG 19/2026 temp petrol cut to 2%
- **Spain (ES):** Temporary excise cuts below ETD minima (Jul–Sep 2026)
- **Slovenia (SI):** 2026→2030 trajectory PRIMARY-ONLY; ZSROVE-1 penalty GAP
- **Croatia (HR):** 2026 overall goal unresolved CONFLICT (8.8/9.5/10.3%)
- **Bulgaria (BG):** Petrol 9% effective-date CONFLICT (2019 vs 2025)
- **Malta (MT):** 2026 substitution % GAP; post-repeal sustainability instrument not located; IX-B exempt
- **Greece (EL):** GHG 8%-2026 step & per-GJ penalty UNCORROBORATED
...
- **Australia (AU):** QLD Amendment Bill legislative outcome uncertain; federal demand measure design & timeline unresolved; sustainability criteria for GO scheme not finalized; biodiesel feedstock cap absent; SAF no mandate (grants only); NSW compliance data not verified.
- **Bolivia (BO):** E21/E25 transition dates TBD; Biodiesel blending target %; Plant II commissioning date uncertain; sustainability regime gaps.
- **China (CN):** SAF 2% 2025 target not achieved (1% pilot only); no national sustainability or feedstock criteria; 2026 ethanol production/consumption data not yet published; policy vs. implementation gap on SAF phasing
- **Ecuador (EC):** E10 target not being met (2–4% actual vs. 10% target); no legislative 2030 target; enforcement mechanisms unclear; sustainability regime gap; biodiesel absent; fuel subsidies may reduce compliance incentive.
- **India (IN):** E25/E30 rollout timeline unresolved; NCCF not yet published; 2025-26 ethanol OMC price overdue; B5 April 2025 penalty mechanism not formally published
- **Japan (JP):** GHG target update spring 2026; provisional tax abolition impact; E10 nationwide deployment 2030 pending vehicle approvals; SAF 5% GHG reduction target needs volumetric clarification; certification scheme mandatory designation unconfirmed; biodiesel timeline GAP
- **Mexico (MX):** PLATEASE contents TBD; future policy direction uncertain; E10 court-blocked; corroboration corrected the Supreme Court E10 ruling date to 22 Jan 2020 (draft said 2025)
- **Uruguay (UY):** E10 references unconfirmed (no Tier 1 source); biodiesel reinstatement status uncertain; soybean oil supply tight.
